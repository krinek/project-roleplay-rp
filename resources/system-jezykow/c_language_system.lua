...
function displayGUI(remotelanguages, rcurrslot)
	if not (wLanguages) then
		...
		wLanguages = guiCreateWindow(x, y, width, height, "Języki: " .. string.gsub(getPlayerName(localPlayer), "_", " "), false)
		...
		if (tlanguages[1]~=nil) then
			...
			local imgLang1 = guiCreateStaticImage(0.05, 0.1+offset, 0.025, 0.025, ":system-kontaktow/images/flags/" .. flags[lang1] .. ".png", true, wLanguages)
			...
			bUse1 = guiCreateButton(0.83, 0.08+offset, 0.2, 0.05, "Użyj", true, wLanguages)
		...
		if (tlanguages[2]~=nil) then
			...
			local imgLang2 = guiCreateStaticImage(0.05, 0.1+offset, 0.025, 0.025, ":system-kontaktow/images/flags/" .. flags[lang2] .. ".png", true, wLanguages)
		...
		if (tlanguages[3]~=nil) then
			...
			local imgLang3 = guiCreateStaticImage(0.05, 0.1+offset, 0.025, 0.025, ":system-kontaktow/images/flags/" .. flags[lang3] .. ".png", true, wLanguages)
			...
			bUse3 = guiCreateButton(0.83, 0.08+offset, 0.2, 0.05, "Użyj", true, wLanguages)
...
fileDelete("c_language_system.lua")