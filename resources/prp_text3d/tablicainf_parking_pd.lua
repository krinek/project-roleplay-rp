...
-- [WZÓR] [x,y,z,r,dimension,interior]
	...
	{1909.20, -1797.22, 13.69,1,0,0,tablica=118, nazwa="(( tablica informacyjna ))\nParking Pomocy Drogowej" },	-- parking pomocy drogowej przy stacji dolnej
...
fileDelete("tablicainf_parking_pd.lua")
