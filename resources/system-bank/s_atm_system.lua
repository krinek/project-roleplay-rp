...
function createATM(thePlayer, commandName)
	if (exports.global:isPlayerAdmin(thePlayer)) then
		...
		if (id) then
			...
			exports['antyczit']:changeProtectedElementDataEx(object, "depositable", 0, false)
			exports['antyczit']:changeProtectedElementDataEx(object, "limit", 5000, false)
...
function loadAllATMs()
	...
	if (result) then
		...
		while continue do
			...
			local object = createObject(2942, x, y, z, 0, 0, rotation-180)
			local marker = createMarker(x, y, z, "cylinder", 1.8, 255, 0, 0, 128)
			exports.pool:allocateElement(object)
			...
			setElementData( marker, "markeratm", object )
			exports['antyczit']:changeProtectedElementDataEx(object, "depositable", deposit, false)
			exports['antyczit']:changeProtectedElementDataEx(object, "limit", limit, false)
