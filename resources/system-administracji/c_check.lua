function CreateCheckWindow()
	...
	Label = {
		...
		guiCreateLabel(0.03,0.26,0.66,0.0887,"Kasa: N/A",true,Window),
		guiCreateLabel(0.03,0.30,0.17,0.0806,"HP: N/A",true,Window),
		guiCreateLabel(0.27,0.34,0.30,0.0806,"Kamizelka: N/A",true,Window),
		guiCreateLabel(0.03,0.34,0.17,0.0806,"Skin: N/A",true,Window),
		guiCreateLabel(0.27,0.30,0.30,0.0806,"Broń: N/A",true,Window),
		guiCreateLabel(0.03,0.38,0.66,0.0806,"Frakcja: N/A",true,Window),
		guiCreateLabel(0.03,0.18,0.66,0.0806,"Ping: N/A",true,Window),
		guiCreateLabel(0.03,0.42,0.66,0.0806,"Pojazd: N/A",true,Window),
		guiCreateLabel(0.03,0.46,0.66,0.0806,"Warny: N/A",true,Window),
		guiCreateLabel(0.03,0.50,0.97,0.0766,"Lokacja: N/A",true,Window),
		...
		guiCreateLabel(0.03,0.14,0.66,0.0887,"Admin Lewel: N/A", true,Window),
		guiCreateLabel(0.7,0.26,0.4093,0.0806,"Ile gra: N/A\n~ Total: N/A",true,Window),
		guiCreateLabel(0.03,0.22,0.66,0.0887,"Punkty: N/A", true,Window),
