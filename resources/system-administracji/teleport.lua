...
function setX(sourcePlayer, commandName, newX)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if not (newX) then
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [x coordinate]", sourcePlayer, 255, 194, 14)
		else
...
function setY(sourcePlayer, commandName, newY)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if not (newY) then
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [y coordinate]", sourcePlayer, 255, 194, 14)
		else
			x, y, z = getElementPosition(sourcePlayer)
...
function setZ(sourcePlayer, commandName, newZ)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if not (newZ) then
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [z coordinate]", sourcePlayer, 255, 194, 14)
		else
			x, y, z = getElementPosition(sourcePlayer)
...
function setXYZ(sourcePlayer, commandName, newX, newY, newZ)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if (newX) and (newY) and (newZ) then
			...
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [x coordnate] [y coordinate] [z coordinate]", sourcePlayer, 255, 194, 14)
		end
	end
end
...
function setXY(sourcePlayer, commandName, newX, newY)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if (newX) and (newY) then
			...
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [x coordnate] [y coordinate]", sourcePlayer, 255, 194, 14)
		end
	end
end
...
function setXZ(sourcePlayer, commandName, newX, newZ)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if (newX) and (newZ) then
			...
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [x coordnate] [z coordinate]", sourcePlayer, 255, 194, 14)
		end
	end
end
...
function setYZ(sourcePlayer, commandName, newY, newZ)
	if (exports.global:isPlayerAdmin(sourcePlayer)) then
		if (newY) and (newZ) then
			...
			outputChatBox("PRZYKŁAD: /" .. commandName .. " [y coordinate] [z coordinate]", sourcePlayer, 255, 194, 14)
		end
	end
end
