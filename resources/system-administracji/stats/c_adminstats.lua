...
addEventHandler( "admin:stats", localPlayer,
	function( results )
		...
		wStats = guiCreateWindow( sx / 2 - 150, sy / 2 - 250, 300, 500, "Statystyki Administratora", false )
		
		local gStats = guiCreateGridList( 0.03, 0.04, 0.94, 0.88, true, wStats )
		local colName = guiGridListAddColumn( gStats, "Nazwa", 0.43 )
		local colTime = guiGridListAddColumn( gStats, "Raporty", 0.23 )
		local colOnline = guiGridListAddColumn( gStats, "Ostatnio Online", 0.5 )
		...
		bClose = guiCreateButton( 0.03, 0.93, 0.94, 0.07, "Zamknij", true, wStats )
