...
function options_showmenu()
	...
	wOptions = guiCreateWindow(left, top, windowWidth, windowHeight, "Menu Gry", false)
	guiWindowSetSizable(wOptions, false)
	
	bChangeCharacter = guiCreateButton(10, 30, 231, 23, "Zmień Postać", false, wOptions)
	...
	bGraphicsSettings = guiCreateButton(10, 65, 231, 23, "Ustawienia gry", false, wOptions)
	addEventHandler("onClientGUIClick", bGraphicsSettings, options_opengraphicsmenu, false)
	--bAccountSettings = guiCreateButton(10, 105, 231, 23, "Ustawienia konta", false, wOptions)
...
function options_opengraphicsmenu()
	...
	wGraphicsMenu = guiCreateWindow(left, top, windowWidth, windowHeight, "Opcje Gry", false)
	guiWindowSetSizable(wGraphicsMenu, false)
	
	cMotionBlur = guiCreateCheckBox(10, 25, 290, 17, "Włacz Blur", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cMotionBlur, options_updateGameConfig)
	
	cSkyClouds = guiCreateCheckBox(10, 45, 290, 17, "Włacz chmury", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cSkyClouds, options_updateGameConfig)
	
	cStreamingAudio = guiCreateCheckBox(10, 65, 290, 17, "Włacz strumienie audio", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cStreamingAudio, options_updateGameConfig)
	
	lVehicleStreamer = guiCreateCheckBox ( 10, 95, 290, 17, "Strumienie pojazdów: Wyłaczone", false, false, wGraphicsMenu )
	...
	lPickupStreamer = guiCreateCheckBox ( 10, 125, 290, 17, "Strumienie interiorów", false, false, wGraphicsMenu )
	...
	cLogsEnabled = guiCreateCheckBox(10, 160, 290, 17, "Wylogowywanie czatem", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cLogsEnabled, options_updateGameConfig)
	
	cBubblesEnabled = guiCreateCheckBox(10, 180, 290, 17, "Włacz czatowe-buuble", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cBubblesEnabled, options_updateGameConfig)
	
	cIconsEnabled = guiCreateCheckBox(10, 200, 290, 17, "Włacz typujšce ikony", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cIconsEnabled, options_updateGameConfig)
	
	cEnableNametags = guiCreateCheckBox(10, 220, 290, 17, "Włacz nametagi", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableNametags, options_updateGameConfig)
	
	cEnableRShaders = guiCreateCheckBox(10, 240, 290, 17, "Włacz shader radaru", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableRShaders, options_updateGameConfig)
	
	cEnableWShaders = guiCreateCheckBox(10, 260, 290, 17, "Włacz shader wody", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableWShaders, options_updateGameConfig)
	
	bGraphicsMenuClose = guiCreateButton(10, 285, 290, 23, "Zamknij", false, wGraphicsMenu)
