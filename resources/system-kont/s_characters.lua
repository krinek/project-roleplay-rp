...
function spawnCharacter(characterID)
	...
	if characterData then
		...
		exports['system-przedmiotow']:loadItems( client, true )
		...
		elseif tonumber(characterData["pdjail"]) == 1 then -- PD JAIL
			...
			exports['system-policji']:timerPDUnjailPlayer(client)
		end
		...
		setElementDataEx(client, "duty", 0)
...
function removeMasksAndBadges(client)
	for k, v in ipairs({exports['system-przedmiotow']:getMasks(), exports['system-przedmiotow']:getBadges()}) do
