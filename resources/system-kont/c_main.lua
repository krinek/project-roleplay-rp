...
gamemodeText = guiCreateLabel(0,sy-25, sx-70, 24, "Project-roleplay v " .. scriptVersion .. " powered by    ", false)
...
--local label = guiCreateLabel( 0, 0, screenX, 15, "Project-roleplay v"..scriptVersion, false )
