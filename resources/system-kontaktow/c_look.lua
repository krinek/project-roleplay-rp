...
function createLookWindow( name, description, attributes, editFunction )
	...
	local column = guiGridListAddColumn( grid, "Przedmioty ", 0.95)
	...
	local close = guiCreateButton( x, 295, 130, 25, "Zamknij", false, advlook_window )
...
addEventHandler( "social:look", getRootElement( ),
	function( age, race, gender, weight, height, description )
		local editButton = createLookWindow( getPlayerName( source ):gsub( "_", " " ),
			getPlayerName( source ):sub( 1, getPlayerName( source ):find( "_" ) ) .. " jest " ..
			age .. " letnim " .. ( race == 0 and "Czarnoskórym" or race == 1 and "białoskórym" or "Azjatą" ) .. " " .. ( gender == 1 and "Kobietą" or "Męzczyzną" ) ..
			" o wadze " .. weight .. "kg" ..
			" i wzroście " .. height .. "cm.\n" ..
			"Kolor Wslosów: " .. description[1] .. "\n" ..
			"fryzura: " .. description[2] .. "\n" ..
			"Facial Features: " .. description[3] .. "\n" ..
			"Physical Features: " .. description[4] .. "\n" ..
			"Clothing: " .. description[5] .. "\n" ..
			"Akcesoria: " .. description[6],
			description[7] or {},
