...
addEventHandler( "showCKList", getLocalPlayer(),
	function( names, data )
		if wCK then
			...
			local windowname = data == 2 and "Zmarli ..." or "Poszukiwania"
			...
			bClose = guiCreateButton( 0.03, 0.93, 0.94, 0.07, "Zamknij", true, wCK )
...
function showCKInfo(text, name)
	...
	local cbutton = guiCreateButton(0.05, 0.85, 0.87, 0.1, "Zamknij menu", true, ckInfoWindow)
