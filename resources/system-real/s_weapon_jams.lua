function toggleFiring(enabled, showJamMessage)
	...
	if (showJamMessage) then
		exports.global:sendLocalMeAction(source, " broń , zablokowała się.")
	end
end
...
function weaponJammed()
	exports['antyczit']:changeProtectedElementDataEx(source, "jammed", 1, false)
end
addEvent("jammed", true)
addEventHandler("jammed", getRootElement(), weaponJammed)

function weaponUnjammed()
	exports['antyczit']:changeProtectedElementDataEx(source, "jammed", 0, false)
end
