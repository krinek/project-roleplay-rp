				...
				if pTheTeam then
					...
					if allowedFactionTypes[pFactionType]  then
						...
						if (duty > 0) then
							...
							outputChatBox("Jednostka odnaczona kolorem '".. backupColours[availableColourIndex][4]  .."' (" .. factionShortName ..") Opanowała sytuacje.", theArrayPlayer, 255, 194, 14)
						end
					end	
				end
			end	
				...
				if pTheTeam then
					...
					if allowedFactionTypes[pFactionType]  then
						...
						if (duty > 0) then
							...
							outputChatBox("Jednostka oznaczona kolorem '".. backupColours[availableColourIndex][4]  .."'  (" .. factionShortName ..") Potrzebuje wsparcia!", theArrayPlayer, 255, 194, 14)
						end
					end	
				end
			end		
...
addCommandHandler("wsparcie", startBackup)
		...
		for keyValue, theArrayPlayer in ipairs( getElementsByType("player") ) do
			...
			if pTheTeam then
				...
				if allowedFactionTypes[pFactionType]  then
					...
					local duty = tonumber(getElementData(theArrayPlayer, "duty"))
					if (duty > 0) then
						outputChatBox("Kolor '".. backupColours[availableColourIndex][4]  .."' unit (" .. factionShortName ..")  nie wymaga już wsparcia , kontynuujcie normalny patrol.", theArrayPlayer, 255, 194, 14)
					end
				end	
			end
		end	
