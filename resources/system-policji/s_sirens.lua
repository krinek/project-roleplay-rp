function vehicleBlown()
	exports['antyczit']:changeProtectedElementDataEx(source, "lspd:siren", false)
...
function setSirenState(enabled)
	...
	if not isOwnedByFactionType(theVehicle, {2, 3, 4}) or not exports.global:hasItem(theVehicle, 85) then
		exports['antyczit']:changeProtectedElementDataEx(theVehicle, "lspd:siren", false)
		outputChatBox("Sirens don't seem to work in this car...", client, 255, 0, 0)
		return false
	end
	exports['antyczit']:changeProtectedElementDataEx(theVehicle, "lspd:siren", enabled)
