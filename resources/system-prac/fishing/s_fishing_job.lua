	...
	if (isElement(thePlayer)) then
		...
		if (logged==1) then
			...
			if not(exports.global:hasItem(thePlayer, 49)) then -- does the player have the fishing rod item?
				outputChatBox("Potrzebujesz wędki by łowić ryby.", thePlayer, 255, 0, 0)
			else
...
function catchFish(fishSize, totalCatch)
	exports.global:sendLocalMeAction(client,"łapie rybę o wadze ".. fishSize .."lbs.")
...
function unloadCatch( totalCatch, profit)
	...
	exports.global:sendLocalMeAction(source,"sprzedaje " .. totalCatch .."lbs ryb.")
