...
function busAdNextStop(line, stop)
	...
	exports.global:sendLocalText(source, " -- Przystanek: [".. g_bus_routes[line].stops[stop] .. "] --", 255, 51, 102)
	if(stop<#g_bus_routes[line].stops)then
		exports.global:sendLocalText(source, " -- Następny Przystanek: [".. g_bus_routes[line].stops[stop+1] .. "] --", 255, 51, 102)
	end
end
